...
!(function () {
  var e = {
      ...
      "zh-TW": {
        title: "軟體需要更新",
        message: "由於您設備上的軟體版本過低，暫時無法運行此內容。",
        "android-tip":
          "在安卓系統上，要解決這個問題，請確保 [a1]Android System Webview[/a1] 應用程序已啟用自動更新並處於最新狀態。",
        "ios-tip":
          "如果您的設備處於[b]鎖定模式[/b]，請在系統設定 - 隱私與安全性，關閉鎖定模式再次嘗試。",
        "general-tip": "請嘗試更新系統版本，或者更換另一臺設備運行。",
      },
    },
