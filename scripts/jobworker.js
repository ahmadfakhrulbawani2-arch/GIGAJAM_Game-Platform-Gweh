...
function SendResult(e, t) {
  if (!e) {
    ...
    self.outputPort.postMessage(
      { type: "result", jobId: self.activeJobId, result: t.result },
      e,
    );
  }
  SendDone();
...
function OnDispatchWorkerMessage(e) {
  ...
  if (((self.activeJobId = r), self.JobHandlers.hasOwnProperty(s))) {
    ...
    a && a.then
      ? a
          .then((e) => SendResult(o, e))
          .catch((e) => SendError(o, "Rejection in job handler: " + e))
      : SendResult(o, a);
...
((self.dispatchPort = null),
  ...
  (self.JobHandlers["ProcessImageData"] = function (e) {
    const t = e["buffer"],
      ...
      o = e["height"];
    return (
      e["flipY"] && FlipImageData(s, r, o),
      e["unpremultiply"] && UnpremultiplyImageData(s),
      { result: t, transferables: [t] }
    );
  }),
