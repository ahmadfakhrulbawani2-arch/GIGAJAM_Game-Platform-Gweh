...
((window.DOMHandler = class {
  ...
  _PostToRuntimeMaybeSync(t, i, e) {
    this._iRuntime.UsesWorker()
      ...
      : this._iRuntime._OnLocalRuntimeMessageFromDOM({
          type: "event",
  ...
  AddRuntimeMessageHandlers(t) {
    for (const [i, e] of t) this.AddRuntimeMessageHandler(i, e);
  }
  GetRuntimeInterface() {
  ...
  (window.RateLimiter = class {
    ...
    Call() {
      ...
      const t = Date.now(),
        ...
        e = this._interval;
      i >= e && this._canRunImmediate
        ? ((this._lastCallTime = t), this._RunCallback())
...
("use strict");
{
  ...
  window.DOMElementHandler = class extends self.DOMHandler {
    ...
    PostToRuntimeElement(e, t, n) {
      (n || (n = {}), (n["elementId"] = t), this.PostToRuntime(e, n));
    }
    _PostToRuntimeElementMaybeSync(e, t, n) {
      (n || (n = {}), (n["elementId"] = t), this._PostToRuntimeMaybeSync(e, n));
    }
    _OnSetVisible(e) {
      ...
      const t = this._elementMap.get(e["elementId"]),
        n = t.GetElement();
      t.HadFirstUpdate()
        ? (n.style.display = e["isVisible"] ? "" : "none")
        : t.SetVisibleFlag(e["isVisible"]);
    }
    _OnUpdatePosition(e) {
      if (!this._autoAttach) return;
      const t = this._elementMap.get(e["elementId"]),
      ...
      (d !== t.GetHTMLZIndex() &&
        (t.SetHTMLZIndex(d), s._UpdateHTMLElementsZOrder()),
        t.HadFirstUpdate() ||
          (t.SetHadFirstUpdate(),
    ...
    _OnHTMLLayersChanged() {
      if (this._autoAttach)
        for (const e of this._elementMap.values()) {
          const t = this.GetRuntimeInterface().GetAvailableHTMLIndex(
              e.GetWantHTMLIndex(),
            ),
...
("use strict");
{
  const e = /(iphone|ipod|ipad|macos|macintosh|mac os x)/i.test(
      navigator.userAgent,
    ),
  ...
  let w = !1;
  window.RuntimeInterface = class s {
    #e = !0;
    #t = null;
    #n = "";
    #s = "";
    ...
    constructor(e) {
      if (
        ...
        (this.#I = e.exportType),
        ("playable-ad-single-file" !== this.#I &&
          "playable-ad-zip" !== this.#I &&
          "instant-games" !== this.#I) ||
          (this.#e = !1),
        (n || "macos-wkwebview" === this.#I) && (this.#e = !1),
        "cordova" === this.#I && this.#e && t)
      ) {
      ...
      (this.IsAnyWebView2Wrapper()
        ? self["chrome"]["webview"].addEventListener("message", (e) =>
            this.#S(e.data, e["additionalObjects"]),
          )
        : "macos-wkwebview" === this.#I
          ? (self["C3WrapperOnMessage"] = (e) => this.#S(JSON.parse(e)))
          : "linux-cef" === this.#I &&
            self["c3_linux_cef_set_message_callback"]((e) =>
              this.#S(JSON.parse(e)),
            ),
        ...
        this.AddRuntimeComponentMessageHandler(
          "canvas",
          "update-html-layer-dom-state",
          (e) => this.#O(e["layersDomState"]),
        ),
        this.AddRuntimeComponentMessageHandler(
          "runtime",
          "create-job-worker",
        ...
        this.AddRuntimeComponentMessageHandler(
          "runtime",
          "send-raw-wrapper-extension-message",
          (e) => this.#x(e),
        ),
        "cordova" === this.#I
          ? document.addEventListener("deviceready", () => this.#A(e))
          : this.#A(e),
        (this._skipAndroidVirtualKeyboardDetection = 0));
    }
    Release() {
      (this._CancelAnimationFrame(),
        this.#t && ((this.#t.onmessage = null), (this.#t = null)),
        this.#r && (this.#r.terminate(), (this.#r = null)),
    ...
    IsAnyWebView2Wrapper() {
      return this.IsWindowsWebView2() || "xbox-uwp-webview2" === this.#I;
    }
    ...
    *_CanDoAndroidVirtualKeyboardDetection() {
    ...
    async #A(e) {
      ...
      if (
        ...
        this.#n = e.runtimeBaseUrl;
      else {
        const e = location.origin;
        this.#n = ("null" === e ? "file:///" : e) + location.pathname;
        const t = this.#n.lastIndexOf("/");
        -1 !== t && (this.#n = this.#n.substr(0, t + 1));
      }
      ...
      if (
        ...
        window["c3_addPortMessageHandler"] &&
          window["c3_addPortMessageHandler"]((e) => this.#F(e)),
      ...
      this.#e ? await this.#D(e, t.port2) : await this.#U(e, t.port2);
    }
    #B(e) {
      return {
        runtimeBaseUrl: this.#n,
        ...
        isFullscreen: s.IsDocumentFullscreen(),
        swClientId: window["cr_swClientId"] || "",
        exportType: e.exportType,
        fileMap:
          globalThis.c3_swFileMap ??
          new Map(Object.entries(this._localFileBlobs ?? {})),
        scriptFolder: this.#s,
    ...
    async #D(e, t) {
      const n = e.workerMainUrl;
      "preview" === this.#I
        ? ((this.#r = new Worker("previewworker.js", {
            type: "module",
            name: "Runtime",
          })),
          await new Promise((e, t) => {
            const s = (n) => {
              (this.#r.removeEventListener("message", s),
                n.data && "ok" === n.data["type"] ? e() : t());
            };
            (this.#r.addEventListener("message", s),
              this.#r.postMessage({
                type: "construct-worker-init",
                import: new URL(n, this.#n).toString(),
              }));
          }))
        : (this.#r = await this.CreateWorker(n, {
            type: "module",
            name: "Runtime",
          }));
      const s = document.createElement("canvas");
      s.style.display = "none";
      const r = s["transferControlToOffscreen"]();
      ...
      ((i.className = "c3htmlwrap"),
        ...
        (self["c3_callFunction"] = (e, t) =>
          this.#o._InvokeFunctionFromJS(e, t)),
        "preview" === this.#I &&
    ...
    async #U(e, t) {
      ...
      ((s.className = "c3htmlwrap"),
        ...
        this.#o._AddDefaultHTMLWrapEventHandlers(s));
      const i = await this.#V(e.runtimeMainScript);
      let a, o;
      ((globalThis["C3_SetInitFunctions"] = (e, t) => {
        ((a = e), (o = t), (globalThis["C3_SetInitFunctions"] = null));
      }),
        await r(i));
      const d = e.projectMainScriptPath,
        c = e.javaScriptInEventsPath,
        p = e.typeScriptInEventsPath;
      if (d)
        try {
          if (
            (await r(d),
            "preview" === this.#I && !globalThis.C3_ProjectMainScriptOK)
          )
          ...
          (this.#j(),
            ...
            alert(
              `Failed to load the project main script (${d}). Check all your JavaScript code has valid syntax, all imports are written correctly, and that an exception was not thrown running the script. Press F12 and check the console for error details.`,
            ));
        }
      if (c)
        try {
          if (
            (await r(c),
            "preview" === this.#I && !globalThis.C3.JavaScriptInEvents)
          )
      ...
      if (p)
        try {
          if (
            (await r(p),
            "preview" === this.#I && !globalThis.C3.TypeScriptInEvents)
          )
      ...
      const m = Object.assign(this.#B(e), {
        isInWorker: !1,
        messagePort: t,
        canvas: n,
    ...
    async CreateWorker(e, t) {
      ...
      if ("playable-ad-single-file" === this.#I) {
        const n = this._localFileBlobs[e];
        if (!n) throw new Error("missing script: " + e);
        return new Worker(URL.createObjectURL(n), t);
      }
      const n = new URL(e, location.href);
      if (location.origin !== n.origin) {
    ...
    GetCssDisplayMode() {
      ...
      return new Set(["cordova", "macos-wkwebview", "linux-cef"]).has(e)
        ? "standalone"
    ...
    async #H(e) {
      ...
      return { outputPort: t, transferables: [t] };
    }
    #L(e) {
      ...
      for (const { canvas: e, htmlWrap: i } of this.#d)
        ((e.style.width = t),
          ...
          (i.style.marginTop = r),
          this.#l && ((e.style.display = ""), (i.style.display = "")));
    ...
    _OnSetHTMLLayerCount(e) {
      ...
      if (t < this.#d.length)
        for (; this.#d.length > t; ) {
          ...
          (t.remove(), this.#e && !s ? this.#c.push(e) : e.remove());
        }
      else if (t > this.#d.length)
        for (let e = 0, n = t - this.#d.length; e < n; ++e) {
          const e = document.createElement("canvas");
          if ((e.classList.add("c3overlay"), this.#e)) {
      ...
      return (
        ...
        { addedCanvases: l, transferables: d }
      );
    }
    #O(e) {
      for (let t = 0, n = Math.min(this.#d.length, e.length); t < n; ++t) {
        const { htmlWrap: n, lastHtmlLayerDomState: s } = this.#d[t],
          r = e[t],
          i = r["isVisible"],
          a = r["opacity"],
          o = r["isInteractive"];
        (i !== s.isVisible &&
          ((n.style.display = i ? "" : "none"), (s.isVisible = i)),
          a !== s.opacity &&
            ((n.style.opacity = 1 === a ? "" : String(a)), (s.opacity = a)),
          o !== s.isInteractive &&
            ((n.style.pointerEvents = o ? "" : "none"),
            o
              ? n.setAttribute("interactive", "")
              : n.removeAttribute("interactive"),
            (s.isInteractive = o)));
      }
    }
    #P() {
      for (const e of this.#c) e.remove();
      this.#c.length = 0;
    }
    _UpdateHTMLElementsZOrder() {
      this.#p || ((this.#p = !0), this._AddRAFCallback(this.#h));
    }
    #m() {
      (this._RemoveRAFCallback(this.#h), (this.#p = !1));
      let e = [];
      for (const t of this.#a)
        if (t instanceof window.DOMElementHandler) {
          const n = t._GetAllElementStatesForZOrderUpdate();
          n && e.push(...n);
        }
      e.sort((e, t) => {
        const n = e.GetActualHTMLIndex(),
      ...
      for (; s < r; ++s) {
        const r = e[s];
        r.GetActualHTMLIndex() !== t &&
          (this.#Z(t, e.slice(n, s)), (t = r.GetActualHTMLIndex()), (n = s));
      }
      n < s && this.#Z(t, e.slice(n, s));
    }
    #Z(e, t) {
      if (t.length <= 1) return;
      if (e >= this.#d.length) return;
      const n = t.map((e) => e.GetElement()),
        s = new Set(n),
        r = this.GetHTMLWrapElement(e),
        i = Array.from(r.children).filter((e) => s.has(e));
      for (let e = 0, t = 0, s = n.length; e < s; ++e) {
        const s = n[e],
          a = i[t];
        s === a
          ? ++t
    ...
    _OnLocalRuntimeMessageFromDOM(e) {
      if (this.#e) throw new Error("not available in worker mode");
      this.#i["_OnMessageFromDOM"](e);
    }
    PostToRuntimeComponent(e, t, n, s, r) {
      this.#t.postMessage(
        {
          type: "event",
          component: e,
    ...
    PostToRuntimeComponentAsync(e, t, n, s, r) {
      const i = p++,
        a = new Promise((e, t) => {
          c.set(i, { resolve: e, reject: t });
        });
      return (
        this.#t.postMessage(
          {
    ...
    _OnMessageFromRuntime(e) {
      const t = e["type"];
      if ("event" === t) return this.#J(e);
      if ("result" === t) this.#$(e);
      else if ("runtime-ready" === t) this.#q();
      else if ("alert-error" === t) (this.#j(), alert(e["message"]));
      else {
    ...
    #J(e) {
      ...
      if (!i)
        return void console.warn(
          `[DOM] No event handlers for component '${t}'`,
        );
      const a = i.get(n);
      if (!a)
        return void console.warn(
          `[DOM] No handler '${n}' for component '${t}'`,
        );
      let o = null;
      try {
        o = a(s);
    ...
    #K(e, t, n) {
      let s;
      (n && n["transferables"] && (s = n["transferables"]),
        this.#t.postMessage(
          { type: "result", responseId: e, isOk: t, result: n },
          s,
        ));
    }
    #$(e) {
      const t = e["responseId"],
        ...
        s = e["result"],
        r = c.get(t);
      (n ? r.resolve(s) : r.reject(s), c.delete(t));
    }
    AddRuntimeComponentMessageHandler(e, t, n) {
      let s = d.get(e);
      if ((s || ((s = new Map()), d.set(e, s)), s.has(t)))
        throw new Error(`[DOM] Component '${e}' already has handler '${t}'`);
      s.set(t, n);
    }
    static AddDOMHandlerClass(e) {
      if (l.includes(e)) throw new Error("DOM handler already added");
      l.push(e);
    }
    #G() {
      for (const e of this.#a)
        if ("runtime" === e.GetComponentID()) return void (this.#o = e);
    ...
    #q() {
      for (const e of this.#a) e.Attach();
    }
    ...
    _AddRAFCallback(e) {
      (this.#b.add(e), this._RequestAnimationFrame());
    }
    _RemoveRAFCallback(e) {
      (this.#b.delete(e), 0 === this.#b.size && this._CancelAnimationFrame());
    }
    _RequestAnimationFrame() {
      -1 === this.#g &&
        this.#b.size > 0 &&
        (this.#g = requestAnimationFrame(this.#f));
    }
    ...
    AddAnyGamepadInputCallback(e) {
      this.#o._AddAnyGamepadInputCallback(e);
    }
    RemoveAnyGamepadInputCallback(e) {
      this.#o._RemoveAnyGamepadInputCallback(e);
    }
    SetSilent(e) {
      this.#o.SetSilent(e);
    }
    ...
    async #V(e) {
      if ("playable-ad-single-file" === this.#I) {
        if (this._localFileStrings.hasOwnProperty(e))
          return { isStringSrc: !0, str: this._localFileStrings[e] };
    ...
    #X(e, t) {
      const n = e[t];
      if ("string" != typeof n) throw new Error("Invalid permission name");
      return n;
    }
    #Y(e) {
      const t = this.#N();
      return new Promise((n, s) =>
        t["checkPermission"](this.#X(t, e), (e) => n(!!e["hasPermission"]), s),
      );
    }
    #Q(e) {
      const t = this.#N();
    ...
    async RequestPermissions(e) {
      ...
      for (const t of e) {
        if (await this.#Y(t)) continue;
        if (!1 === (await this.#Q(t))) return !1;
      }
      return !0;
    }
    ...
    #S(e, t) {
      ...
      const n = e["type"];
      if ("directory-handles" === n) this.#C = t;
      else if ("wrapper-init-response" === n) (this.#M(e), (this.#M = null));
      else if ("fullscreen-change" === n)
        (s._SetWrapperIsFullscreenFlag(e["isFullscreen"]),
          this.#o._OnFullscreenChange());
      else if ("log-to-console" === n)
        switch (e["logType"]) {
          case "error":
      ...
      else if ("window-maximized" == n || "window-minimized" == n) {
        const e = {
          "window-maximized": "windowmaximize",
          "window-minimized": "windowminimize",
        };
        this.PostToRuntimeComponent("runtime", e[n], null, {
          dispatchRuntimeEvent: !0,
          dispatchUserScriptEvent: !0,
        });
      } else if ("extension-message" === n)
        this.PostToRuntimeComponent("runtime", "wrapper-extension-message", e);
      else {
        const t = this.#R.get(n);
    ...
    _SendWrapperMessage(e) {
      this.IsAnyWebView2Wrapper()
        ...
        : "macos-wkwebview" === this.#I
          ...
          : "linux-cef" === this.#I &&
            window["c3_linux_cef_sendmessage"](JSON.stringify(e));
    }
    #k() {
      ((window.moveTo = (e, t) => {
        this._SendWrapperMessage({
        ...
        (window.focus = () => {
          this._SendWrapperMessage({ type: "focus-window" });
        }));
    }
    #E() {
      return new Promise((e) => {
        ((this.#M = e), this._SendWrapperMessage({ type: "wrapper-init" }));
      });
    }
    ...
    async #ee(e, t) {
      if ("object" == typeof t)
        ((this._localFileBlobs[e] = new Blob([t["str"]], { type: t["type"] })),
          (this._localFileStrings[e] = t["str"]));
      else {
        let n = await this.#te(t);
        (n || (n = this.#ne(t)), (this._localFileBlobs[e] = n));
      }
    }
    async #te(e) {
      try {
    ...
    #ne(e) {
      const t = this.#se(e);
      return this.#re(t.data, t.mime_type);
    }
    #se(e) {
      const t = e.indexOf(",");
      if (t < 0) throw new URIError("expected comma in data: uri");
      const n = e.substring(5, t),
        s = e.substring(t + 1),
        r = n.split(";"),
        i = r[0] || "",
        a = r[1],
      ...
      return (
        (l =
          "base64" === a || "base64" === o ? atob(s) : decodeURIComponent(s)),
        { mime_type: i, data: l }
      );
    }
    #re(e, t) {
      let n,
        ...
        i = r >> 2,
        a = new Uint8Array(r),
        o = new Uint32Array(a.buffer, 0, i);
      for (n = 0, s = 0; n < i; ++n)
        o[n] =
          e.charCodeAt(s++) |
          (e.charCodeAt(s++) << 8) |
...
("use strict");
{
  ...
  const n = new Map([
    ...
    s = { dispatchRuntimeEvent: !0, dispatchUserScriptEvent: !0 },
    o = { dispatchUserScriptEvent: !0 },
    a = { dispatchRuntimeEvent: !0 };
  async function r(e) {
    ...
    try {
      ...
      new Promise((e, t) => {
        const n = new Image();
        ((n.onload = () => e(n)), (n.onerror = (e) => t(e)), (n.src = i));
      }));
    } finally {
  ...
  ((self["C3_GetSvgImageSize"] = async function (e) {
    ...
    (self["C3_RasterSvgImageBlob"] = async function (e, t, i, n, s) {
      ...
      return (a.getContext("2d").drawImage(o, 0, 0, t, i), a);
    }));
  let p = !1;
  function g() {
    try {
    ...
    w = class extends self.DOMHandler {
      ...
      constructor(e) {
        (super(e, _),
          ...
          e.AddRuntimeComponentMessageHandler(
            "runtime",
            "invoke-download",
            (e) => this._OnInvokeDownload(e),
          ),
          e.AddRuntimeComponentMessageHandler("runtime", "load-webfonts", (e) =>
            this._OnLoadWebFonts(e),
          ),
          e.AddRuntimeComponentMessageHandler(
            "runtime",
            "raster-svg-image",
          ...
          e.AddRuntimeComponentMessageHandler("runtime", "register-sw", () =>
            this._OnRegisterSW(),
          ),
          e.AddRuntimeComponentMessageHandler(
            "runtime",
          ...
          e.AddRuntimeComponentMessageHandler("runtime", "go-to-script", (e) =>
            this._OnPostToDebugger(e),
          ),
          e.AddRuntimeComponentMessageHandler(
            "runtime",
          ...
          e.AddRuntimeComponentMessageHandler("runtime", "alert", (e) =>
            this._OnAlert(e),
          ),
          e.AddRuntimeComponentMessageHandler(
            "runtime",
        ...
        if (
          ...
          window.addEventListener("touchstart", h, { passive: !1 }),
          window.addEventListener("pointerdown", h, { passive: !1 }),
          (this._mousePointerLastButtons = 0),
          window.addEventListener("mousedown", (e) => {
            1 === e.button && e.preventDefault();
          }),
          window.addEventListener("mousewheel", u, { passive: !1 }),
      ...
      _AddDefaultHTMLWrapEventHandlers(e) {
        (e.addEventListener("selectstart", m),
          e.addEventListener("gesturehold", m),
          e.addEventListener("touchstart", m),
          e.addEventListener("dragstart", m));
      }
      ...
      Attach() {
        (window.addEventListener("focus", () =>
          ...
          window.addEventListener("blur", () => {
            (this._PostRuntimeEvent("window-blur", { parentHasFocus: g() }),
              (this._mousePointerLastButtons = 0));
          }),
          window.addEventListener("focusin", (e) => {
            var t;
            ((t = e.target),
              (l.has(t.tagName.toLowerCase()) || d(t)) &&
          ...
          window.addEventListener("mousedown", (e) =>
            this._OnMouseEvent("mousedown", e, o),
          ),
          window.addEventListener("mousemove", (e) =>
            this._OnMouseEvent("mousemove", e, o),
          ),
          window.addEventListener("mouseup", (e) =>
            this._OnMouseEvent("mouseup", e, o),
          ),
          window.addEventListener("dblclick", (e) =>
            this._OnMouseEvent("dblclick", e, s),
          ),
          window.addEventListener("wheel", (e) =>
            this._OnMouseWheelEvent("wheel", e, s),
          ),
        ...
        try {
          navigator.getGamepads().some((e) => !!e) &&
            (this._iRuntime._AddRAFCallback(this._pollGamepadRafCallback),
            (this._isPollingGamepads = !0));
        } catch (e) {
          console.warn(
            "[Construct] Unable to access gamepads for starting media playback: ",
            e,
          );
        }
      ...
      _OnWindowResize() {
        ...
        if (this._iRuntime.IsAndroidWebView())
          if (this._enableAndroidVKDetection) {
            if (
              this._iRuntime.CanDoAndroidVirtualKeyboardDetection() &&
              this._lastWindowWidth === t &&
              i < this._lastWindowHeight
            )
              return (
                (this._virtualKeyboardHeight = this._lastWindowHeight - i),
          ...
          } else ((this._lastWindowWidth = t), (this._lastWindowHeight = i));
        (this.PostToRuntime("window-resize", {
          ...
          this._iRuntime.IsiOSWebView() && this.#t(t, i, 0));
      }
      #t(e, t, i) {
        (-1 !== this.#e && clearTimeout(this.#e),
          (this.#e = setTimeout(() => this.#i(e, t, i), 100)));
      }
      #i(t, i, n) {
        this.#e = -1;
        ...
        if (screen["orientation"] && screen["orientation"]["lock"])
          ...
          try {
            ...
            (screen["lockOrientation"]
              ? (t = screen["lockOrientation"](e))
              : screen["webkitLockOrientation"]
                ? (t = screen["webkitLockOrientation"](e))
                : screen["mozLockOrientation"]
                  ? (t = screen["mozLockOrientation"](e))
                  : screen["msLockOrientation"] &&
                    (t = screen["msLockOrientation"](e)),
      ...
      _OnVisibilityChange(e) {
        if (
          this._pageVisibilityIsHidden !== e &&
          ((this._pageVisibilityIsHidden = e),
          e
            ? this._iRuntime._CancelAnimationFrame()
            : this._iRuntime._RequestAnimationFrame(),
          this.PostToRuntime("visibilitychange", { hidden: e }),
      ...
      _OnKeyEvent(e, t) {
        ...
        if (
          ("Backspace" === t.key && h(t),
          "F5" === t.key &&
            "windows-webview2" === this._iRuntime.GetExportType() &&
            t.preventDefault(),
      ...
      _OnDeviceMotion(e) {
        ...
        i && (t = { x: i["x"] || 0, y: i["y"] || 0, z: i["z"] || 0 });
        let n = null;
        const o = e["accelerationIncludingGravity"];
        o && (n = { x: o["x"] || 0, y: o["y"] || 0, z: o["z"] || 0 });
        let a = null;
      ...
      async _OnRasterSvgImage(e) {
        ...
        let d;
        return (
          (d = a ? await createImageBitmap(r, a) : await createImageBitmap(r)),
          { imageBitmap: d, transferables: [d] }
        );
      }
      ...
      _PlayPendingMedia() {
        ...
        if ((this._mediaPendingPlay.clear(), !this._isSilent))
          for (const t of e) {
            ...
            e &&
              e.catch((e) => {
                this._mediaRemovedPendingPlay.has(t) ||
                  this._mediaPendingPlay.add(t);
              });
          }
      }
      TryPlayMedia(e) {
        ...
        t &&
          t.catch((t) => {
            this._mediaRemovedPendingPlay.has(e) ||
      ...
      _OnGamepadDisconnected() {
        this._isPollingGamepads &&
          navigator.getGamepads().every((e) => !e) &&
          (this._iRuntime._RemoveRAFCallback(this._pollGamepadRafCallback),
          (this._isPollingGamepads = !1));
      }
      _OnPollGamepads() {
        navigator
          .getGamepads()
          .some((e) => e && e.buttons.some((e) => e.pressed)) &&
          this._OnAnyGamepadInput();
      }
      _OnAnyGamepadInput() {
        this._PlayPendingMedia();
        for (const e of this._gamepadInputCallbacks) e();
      }
      ...
      _OnScriptCreateWorker(e) {
        ...
        new Worker(t, i).postMessage(
          { type: "construct-worker-init", port2: n },
          [n],
        );
      }
      _OnAlert(e) {
...
("use strict");
{
  ...
  self.JobSchedulerDOM = class {
    ...
    async _CreateJobWorker() {
      ...
      return (
        this._dispatchWorker.postMessage(
          { type: "_addJobWorker", port: s.port1 },
          [s.port1],
        ),
        o.postMessage(
          {
...
// scripts/plugins/SpeechSynthesis/dom/domSide.js
("use strict");
{
  const e =
    ...
    t = class extends self.DOMHandler {
      constructor(e) {
        (super(e, n),
          (this._voices = []),
          this.AddRuntimeMessageHandler("get-voices", () =>
            this._OnGetVoices(),
          ),
          this.AddRuntimeMessageHandler("speak-text", (e) =>
            this._OnSpeakText(e),
          ),
          this.AddRuntimeMessageHandler("stop-speaking", () =>
            this._OnStopSpeaking(),
          ),
          this.AddRuntimeMessageHandler("pause-speaking", () =>
            this._OnPauseSpeaking(),
          ),
          this.AddRuntimeMessageHandler("resume-speaking", () =>
            this._OnResumeSpeaking(),
          ));
      }
      _OnGetVoices() {
        return (
          e && (this._voices = e["getVoices"]()),
          {
            isSupported: !!e,
            voices: this._voices.map((e) => ({
              name: e["name"],
              lang: e["lang"],
              voiceURI: e["voiceURI"],
            })),
      ...
      _GetVoiceByURI(e) {
        for (const s of this._voices) if (s["voiceURI"] === e) return s;
        return null;
      }
      _OnSpeakText(n) {
        const t = new s(n["text"]);
        (n["lang"] && (t["lang"] = n["lang"]),
          n["voiceURI"] &&
            ((t["voice"] = this._GetVoiceByURI(n["voiceURI"])),
            (t["voiceURI"] = n["voiceURI"])),
          (t["volume"] = n["volume"]),
          (t["rate"] = n["rate"]),
          (t["pitch"] = n["pitch"]),
          (t["onend"] = () => this.PostToRuntime("speech-ended")),
          (t["onerror"] = () => this.PostToRuntime("speech-error")),
          e["speak"](t));
      }
      _OnStopSpeaking() {
        e["cancel"]();
  ...
  ((self.AudioDOMHandler = class extends self.DOMHandler {
    constructor(t) {
      (super(t, e),
        ...
        (self["C3Audio_OnMicrophoneStream"] = (t, e) =>
          this._OnMicrophoneStream(t, e)),
        (this._destMediaStreamNode = null),
        (self["C3Audio_GetOutputStream"] = () => this._OnGetOutputStream()),
        (self["C3Audio_DOMInterface"] = this),
        this.AddRuntimeMessageHandlers([
          ["create-audio-context", (t) => this._CreateAudioContext(t)],
          ["play", (t) => this._Play(t)],
          ["stop", (t) => this._Stop(t)],
          ["stop-all", () => this._StopAll()],
          ["set-paused", (t) => this._SetPaused(t)],
          ["set-volume", (t) => this._SetVolume(t)],
          ["fade-volume", (t) => this._FadeVolume(t)],
          ["set-master-volume", (t) => this._SetMasterVolume(t)],
          ["set-muted", (t) => this._SetMuted(t)],
          ["set-silent", (t) => this._SetSilent(t)],
          ["set-looping", (t) => this._SetLooping(t)],
          ["set-playback-rate", (t) => this._SetPlaybackRate(t)],
          ["set-stereo-pan", (t) => this._SetStereoPan(t)],
          ["seek", (t) => this._Seek(t)],
          ["preload", (t) => this._Preload(t)],
          ["unload", (t) => this._Unload(t)],
          ["unload-all", () => this._UnloadAll()],
          ["set-suspended", (t) => this._SetSuspended(t)],
          ["add-effect", (t) => this._AddEffect(t)],
          ["set-effect-param", (t) => this._SetEffectParam(t)],
          ["remove-effects", (t) => this._RemoveEffects(t)],
          ["tick", (t) => this._OnTick(t)],
          ["load-state", (t) => this._OnLoadState(t)],
          ["offline-render-audio", (t) => this._OnOfflineRenderAudio(t)],
          ["offline-render-finish", () => this._OnOfflineRenderFinish()],
        ]));
    }
    async _CreateAudioContext(t) {
      if (
        (t["usePlayMusicAsSoundWorkaround"] && (this._playMusicAsSound = !0),
      ...
      try {
        await Promise.all(
          t["preloadList"].map((t) =>
            this._GetAudioBuffer(t["originalUrl"], t["url"], t["type"], !1),
          ),
        );
      } catch (t) {
    ...
    _AttachUnblockEvents() {
      this._hasAttachedUnblockEvents ||
        ...
        this._iRuntime.IsiOSWebView() ||
          document.addEventListener("visibilitychange", this._unblockFunc),
    ...
    _DetachUnblockEvents() {
      this._hasAttachedUnblockEvents &&
        ...
        this._iRuntime.IsiOSWebView() ||
          document.removeEventListener("visibilitychange", this._unblockFunc),
        (this._hasAttachedUnblockEvents = !1));
    }
    ...
    _ReconnectEffects(t) {
      ...
      if (s && s.length) {
        ...
        for (let t = 0, e = s.length; t < e; ++t) {
          const i = s[t];
          t + 1 === e
            ? i.ConnectTo(this.GetDestinationNode())
            : i.ConnectTo(s[t + 1].GetInputNode());
        }
      }
      for (const s of this.audioInstancesByEffectTag(t)) s.Reconnect(e);
      this._microphoneSource &&
        this._microphoneTag === t &&
    ...
    *audioInstancesByEffectTag(t) {
    ...
    async _GetAudioBuffer(t, e, s, i, n) {
      for (const t of this._audioBuffers)
        if (t.GetUrl() === e)
          return (
            i && this._playMusicAsSound && (this._lastMusicBuffer = t),
            await t.Load(),
            t
          );
      if (n) return null;
      ...
      return (
        this._audioBuffers.push(o),
        i && this._playMusicAsSound && (this._lastMusicBuffer = o),
        await o.Load(),
        this._loadedAudioUrls.has(t) ||
    ...
    async _GetAudioInstance(t, e, s, i, n) {
      for (const t of this._audioInstances)
        if (t.GetUrl() === e && (t.CanBeRecycled() || n))
          return (
            n &&
              this._playMusicAsSound &&
              (this._lastMusicBuffer = t.GetBuffer()),
            t.SetTags(i),
            t
          );
      ...
      return (this._audioInstances.push(a), a);
    }
    _AddPendingTags(t) {
      const e = t.join(" ");
    ...
    _RemovePendingTags(t) {
      ...
      if (!s) throw new Error("expected pending tag");
      (s.pendingCount--,
        0 === s.pendingCount && (s.resolve(), this._pendingTags.delete(e)));
    }
    TagsReady(t) {
    ...
    _MaybeStartTicking() {
      if (this._analysers.size > 0) this._StartTicking();
        ...
        for (const t of this._audioInstances)
          if (t.IsActive()) return void this._StartTicking();
    }
    Tick() {
      for (const t of this._analysers) t.Tick();
      const t = this.GetAudioCurrentTime();
      for (const e of this._audioInstances) e.Tick(t);
      const e = this._audioInstances
        .filter((t) => t.IsActive())
        .map((t) => t.GetState());
    ...
    PostTrigger(t, e, s) {
      this.PostToRuntime("trigger", { type: t, tags: e, aiid: s });
    }
    async _Play(t) {
        ...
        ((this._lastAudioInstance = await this._GetAudioInstance(
          ...
          u
            ? (this._lastAudioInstance.SetPannerEnabled(!0),
              ...
              u.hasOwnProperty("uid") &&
                this._lastAudioInstance.SetUID(u["uid"]))
            : "number" == typeof d && 0 !== d
              ? (this._lastAudioInstance.SetStereoPannerEnabled(!0),
                this._lastAudioInstance.SetStereoPan(d))
    ...
    async _Stop(t) {
      ...
      for (const t of this.audioInstancesMatchingTags(e)) t.Stop();
    }
    _StopAll() {
      for (const t of this._audioInstances) t.Stop();
    }
    _SetPaused(t) {
      const e = t["tags"],
        s = t["paused"];
    ...
    _SetVolume(t) {
      const e = t["tags"],
        s = t["vol"];
      for (const t of this.audioInstancesMatchingTags(e)) t.SetVolume(s);
    }
    _SetStereoPan(t) {
      const e = t["tags"],
        s = t["p"];
      for (const t of this.audioInstancesMatchingTags(e))
        (t.SetStereoPannerEnabled(!0), t.SetStereoPan(s));
    }
    async _FadeVolume(t) {
      const e = t["tags"],
        s = t["vol"],
        ...
        n = t["stopOnEnd"];
      await this.TagsReady(e);
      for (const t of this.audioInstancesMatchingTags(e)) t.FadeVolume(s, i, n);
      this._MaybeStartTicking();
    }
    _SetMasterVolume(t) {
    ...
    _SetMuted(t) {
      const e = t["tags"],
        s = t["isMuted"];
      for (const t of this.audioInstancesMatchingTags(e)) t.SetMuted(s);
    }
    _SetSilent(t) {
      ((this._isSilent = t["isSilent"]),
        this._iRuntime.SetSilent(this._isSilent));
      for (const t of this._audioInstances) t._UpdateMuted();
    }
    _SetLooping(t) {
      const e = t["tags"],
        s = t["isLooping"];
      for (const t of this.audioInstancesMatchingTags(e)) t.SetLooping(s);
    }
    async _SetPlaybackRate(t) {
      const e = t["tags"],
        s = t["rate"];
      await this.TagsReady(e);
      for (const t of this.audioInstancesMatchingTags(e)) t.SetPlaybackRate(s);
    }
    async _Seek(t) {
      const e = t["tags"],
        s = t["pos"];
      await this.TagsReady(e);
      for (const t of this.audioInstancesMatchingTags(e)) t.Seek(s);
    }
    async _Preload(t) {
      const e = t["originalUrl"],
        s = t["url"],
    ...
    _SetSuspended(t) {
      ...
      for (const t of this._audioInstances) t.SetSuspended(e);
    ...
    _OnTick(t) {
      if (
        ...
        for (const t of this._audioInstances) t._UpdatePlaybackRate();
      const e = t["listenerPos"];
      !e ||
        (this._lastListenerPos[0] === e[0] &&
          this._lastListenerPos[1] === e[1] &&
      ...
      if (
        s &&
        (this._lastListenerOrientation[0] !== s[0] ||
          this._lastListenerOrientation[1] !== s[1] ||
          this._lastListenerOrientation[2] !== s[2] ||
          this._lastListenerOrientation[3] !== s[3] ||
          this._lastListenerOrientation[4] !== s[4] ||
          this._lastListenerOrientation[5] !== s[5])
      ) {
        for (let t = 0; t < 6; ++t) this._lastListenerOrientation[t] = s[t];
        this._audioContext["listener"]["setOrientation"](
          ...this._lastListenerOrientation,
        );
      }
    ...
    async _AddEffect(t) {
      ...
      for (const a of s) {
        if ("filter" === e) n = new self.C3AudioFilterFX(this, ...i);
        else if ("delay" === e) n = new self.C3AudioDelayFX(this, ...i);
        ...
        else if ("flanger" === e) n = new self.C3AudioFlangerFX(this, ...i);
        else if ("phaser" === e) n = new self.C3AudioPhaserFX(this, ...i);
        else if ("gain" === e) n = new self.C3AudioGainFX(this, ...i);
        else if ("stereopan" === e) n = new self.C3AudioStereoPanFX(this, ...i);
        else if ("tremolo" === e) n = new self.C3AudioTremoloFX(this, ...i);
        else if ("ringmod" === e) n = new self.C3AudioRingModFX(this, ...i);
        else if ("distortion" === e)
          n = new self.C3AudioDistortionFX(this, ...i);
        else if ("compressor" === e)
          n = new self.C3AudioCompressorFX(this, ...i);
        else {
          if ("analyser" !== e) throw new Error("invalid effect type");
    ...
    _RemoveEffects(t) {
      ...
      for (const t of e) {
        ...
        for (const t of s) t.Release();
        (this._effects.delete(e), this._ReconnectEffects(e));
      }
    }
    _AddAnalyser(t) {
      (this._analysers.add(t), this._MaybeStartTicking());
    }
    _RemoveAnalyser(t) {
    ...
    _DoPostUpdatedFxState() {
      const t = {};
      for (const [e, s] of this._effects) t[e] = s.map((t) => t.GetState());
      (this.PostToRuntime("fxstate", { fxstate: t }),
        (this._isPendingPostFxState = !1));
    }
    async _OnLoadState(t) {
      ...
      if (3 !== e) {
        const t = [];
        for (const s of this._audioInstances)
          (s.IsMusic() && 1 === e) || (!s.IsMusic() && 2 === e)
            ? t.push(s)
            : s.Release();
        this._audioInstances = t;
      }
      for (const t of this._effects.values()) for (const e of t) e.Release();
      (this._effects.clear(),
        (this._timeScale = t["timeScale"]),
        (this._gameTime = t["gameTime"]));
      ...
      if (Array.isArray(i)) {
        for (let t = 0; t < 6; ++t) this._lastListenerOrientation[t] = i[t];
        this._audioContext["listener"]["setOrientation"](
          ...this._lastListenerOrientation,
        );
      }
      ...
      (await Promise.all(n),
        await Promise.all(
          t["playing"].map((t) => this._LoadAudioInstance(t, e)),
        ),
        this._MaybeStartTicking());
    }
    ...
    _OnMicrophoneStream(t, e) {
      (this._microphoneSource && this._microphoneSource["disconnect"](),
        ...
        (this._microphoneSource =
          this._audioContext["createMediaStreamSource"](t)),
      ...
      try {
        ...
        (this._hasStartedOfflineRender
          ...
          : (this._audioContext["startRendering"]()
              .then((t) => this._OnOfflineRenderCompleted(t))
              .catch((t) => this._OnOfflineRenderError(t)),
    ...
    static EqualsNoCase(t, e) {
      return (
        t === e || t.normalize().toLowerCase() === e.normalize().toLowerCase()
      );
    }
    static ToDegrees(e) {
      return e * t;
...
self.C3AudioBuffer = class {
  ...
  static Create(t, e, i, s, o) {
    return !o || t.IsPlayMusicAsSound()
      ? new self.C3WebAudioBuffer(t, e, i, s, o)
      : new self.C3Html5AudioBuffer(t, e, i, s, o);
  }
  CreateInstance(t) {
    return "html5" === this._api
      ? new self.C3Html5AudioInstance(this._audioDomHandler, this, t)
      : new self.C3WebAudioInstance(this._audioDomHandler, this, t);
  }
  _Load() {}
  Load() {
    return (
...
self.C3Html5AudioBuffer = class extends self.C3AudioBuffer {
  ...
  IsLoaded() {
    ...
    return (
      e && (this._reachedCanPlayThrough = !0),
...
self.C3WebAudioBuffer = class extends self.C3AudioBuffer {
  ...
  async _Fetch() {
    ...
    if (
      "playable-ad-single-file" === a.GetExportType() &&
      ...
      if (!a.ok)
        throw new Error(
          `error fetching audio data: ${a.status} ${a.statusText}`,
        );
  ...
  async _Load() {
    try {
      if (
        ((this._loadState = "loading"), await this._Fetch(), this.WasReleased())
      )
        return;
...
("use strict");
{
  ...
  self.C3AudioInstance = class {
    ...
    SetTags(e) {
      ...
      this._lastEffectTag !== t &&
        ((this._lastEffectTag = t), this.Reconnect(this.GetDestinationNode()));
    }
    GetTags() {
      return this._tags;
    }
    ...
    GetDuration(e) {
      ...
      return (e && (t /= this._playbackRate || 0.001), t);
    }
    Play(e, t, n, i) {}
    Stop() {}
    Pause() {}
    ...
    SetMuted(e) {
      ((e = !!e),
        this._isMuted !== e && ((this._isMuted = e), this._UpdateMuted()));
    }
    IsMuted() {
    ...
    SetPlaybackRate(e) {
      this._playbackRate !== e &&
        ((this._playbackRate = e), this._UpdatePlaybackRate());
    }
    _UpdatePlaybackRate() {}
    GetPlaybackRate() {
    ...
    SetPan(e, t, n, i, s, a, o) {
      ...
      (this._pannerConeParams[0] !== r(s) &&
        ((this._pannerConeParams[0] = r(s)),
        (this._pannerNode["coneInnerAngle"] = r(s))),
        this._pannerConeParams[1] !== r(a) &&
          ((this._pannerConeParams[1] = r(a)),
          (this._pannerNode["coneOuterAngle"] = r(a))),
        this._pannerConeParams[2] !== o &&
          ((this._pannerConeParams[2] = o),
    ...
    SetStereoPan(e) {
      this._isStereoPannerEnabled &&
        this._stereoPan !== e &&
        ((this._stereoPannerNode["pan"]["value"] = e), (this._stereoPan = e));
    }
    SetUID(e) {
      this._instUid = e;
    }
    ...
    LoadStereoPanState(e) {
      "number" == typeof e
        ? (this.SetStereoPannerEnabled(!0), this.SetStereoPan(e))
        : this.SetStereoPannerEnabled(!1);
    }
  };
}
...
self.C3Html5AudioInstance = class extends self.C3AudioInstance {
  ...
  Play(e, t, i, s) {
    ...
    if (
      ...
      try {
        ...
        console.warn(
          `[Construct] Exception seeking audio '${this._buffer.GetUrl()}' to position '${i}': `,
          e,
        );
      }
  ...
  SetLooping(e) {
    ((e = !!e),
      this._isLooping !== e &&
        ((this._isLooping = e), (this.GetAudioElement().loop = e)));
  }
  _UpdatePlaybackRate() {
  ...
  Seek(e) {
    this._isStopped ||
      ...
      (this._isPaused
        ...
        : (this.Pause(), (this._resumePosition = e), this.Resume()));
  }
  GetResumePosition() {
  ...
  ((self.C3AudioFilterFX = class extends e {
    ...
    (self.C3AudioConvolveFX = class extends e {
      ...
      GetState() {
        ...
        return (
          (e["bufferOriginalUrl"] = this._bufferOriginalUrl),
          (e["bufferUrl"] = ""),
    ...
    (self.C3AudioStereoPanFX = class extends e {
      ...
      SetParam(e, t, i, s) {
        if (((t = Math.min(Math.max(t / 100, -1), 1)), 9 === e))
          ((this._params[0] = t),
    ...
    (self.C3AudioDistortionFX = class extends e {
      ...
      _SetDrive(e, t) {
        (e < 0.01 && (e = 0.01),
          ...
          (this._postGain["gain"]["value"] = Math.pow(1 / e, 0.6) * t));
      }
...
("use strict");
{
  const r = "keyboard",
    o = class extends self.DOMHandler {
      constructor(o) {
        (super(o, r),
          (this._isKeyboardLockSupported = !(
            !navigator["keyboard"] || !navigator["keyboard"]["lock"]
          )),
          this.AddRuntimeMessageHandlers([
            ["init", () => this._OnInit()],
            ["lock-keyboard", (r) => this._OnLockKeyboard(r)],
        ...
        try {
          return (
            0 === o.length
              ...
              : await navigator["keyboard"]["lock"](o),
            { isOk: !0 }
          );
        } catch (r) {
          return (console.error("Error locking keyboard:", r), { isOk: !1 });
        }
      }
      _OnUnlockKeyboard() {
        try {
    ...
    t = class extends self.DOMHandler {
      ...
      constructor(t) {
        (super(t, e),
          this.AddRuntimeMessageHandlers([
            ["init", (e) => this.#r(e)],
            ["cursor", (e) => this.#n(e)],
            ["request-pointer-lock", (e) => this.#i(e)],
            ["release-pointer-lock", () => this.#s()],
          ]),
          document.addEventListener("pointerlockchange", (e) => this.#l()),
          document.addEventListener("pointerlockerror", (e) => this.#a()));
      }
      #r(e) {
        ((this.#e = e["isPointerLockWrapperPolyfill"]),
          this.#e &&
            (this._iRuntime._AddWrapperMessageHandler(
              "set-pointer-lock-enabled-response",
              (e) => this.#c(e),
            ),
            this._iRuntime._AddWrapperMessageHandler(
            ...
            window.addEventListener("blur", () => this.#h())));
      }
      #n(e) {
        ((this.#o = e),
          ("linux-cef" === this._iRuntime.GetExportType() && this.#t) ||
            (document.documentElement.style.cursor = e));
      }
      #i(e) {
        this.#e
          ? ("linux-cef" === this._iRuntime.GetExportType() &&
              ((this.#t = !0),
      ...
      #c(e) {
        (e["isOk"]
          ...
          : (console.error(
              `[Mouse] Unable to obtain pointer lock (via wrapper): error ${e["error"]}`,
            ),
            (this.#t = !1),
            this.PostToRuntime("pointer-lock-error", { hasPointerLock: !1 })),
          "linux-cef" !== this._iRuntime.GetExportType() ||
            this.#t ||
            (document.documentElement.style.cursor = this.#o));
      }
      #p(e) {
